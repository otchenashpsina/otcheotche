...
style window:
    ...
    background Image("gui/textbox.png", xalign=100, yalign=100)
...
screen navigation():
    ...
    vbox:
        ...
        if main_menu:
            ...
            textbutton _("предметы") action Start()
        ...
        textbutton _("О приложении") action ShowMenu("about")
...
screen about():
    ...
    use game_menu(_("О приложении"), scroll="viewport"):
